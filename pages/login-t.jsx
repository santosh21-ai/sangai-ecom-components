              ...
              <form className="mt-12" action="" method="POST">
                <div className="relative">
                  <input
                    ...
                    name="email"
                    type="text"
                    className="peer h-10 w-full border-b-2 border-gray-300 border-x-0 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600 focus:border-x-0"
