      ...
      <div>
        ...
        <main className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-x-8 gap-y-10 divide-x-2">
              {/* Filters */}
                          ...
                          <a className="group">
                            ...
                            <div className="items-center">
                              <div className="flex">
                                ...
                                <HeartIcon className="w-7 h-7 mt-3 text-red-700 ml-4" />
                              </div>
                              <div className="flex mt-1">
                                <StarIcon className="h-5 w-5 text-indigo-600 hover:text-indigo-700" />
                                <StarIcon className="h-5 w-5 text-indigo-600 hover:text-indigo-700" />
                                <StarIcon className="h-5 w-5 text-indigo-600 hover:text-indigo-700" />
                                <StarIcon className="h-5 w-5 text-indigo-600 hover:text-indigo-700" />
                                <StarIcon className="h-5 w-5 text-gray-300 hover:text-gray-400" />
                              </div>
